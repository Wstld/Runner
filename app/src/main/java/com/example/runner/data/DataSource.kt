...
object DataSource {
    val data = createList()
        fun createList():MutableList<Employee>{
            ...
            mainList.add(
                Employee(331,"Sara Sarasson",3,"2020-08-12",competence =  Competence(chief = true))//Only Chief
            )
            mainList.add(
            ...
            mainList.add(
                Employee(222,"Mats Matsson",2,"2020-07-16",competence =  Competence(searchAndRescue = true,driverTruck = true,driverLadder = true))//Search and Rescue + diver both trucks
            )
            mainList.add(
                Employee(633,"Sven Svensson",3,"2020-05-11",competence =  Competence(searchAndRescue = true,searchAndRescueLeader = true,driverTruck = true))//Search and Rescue Leader + Driver truck
            )
            mainList.add(
                Employee(170,"Ping Pingsson",4,"2020-01-02",competence =  Competence(searchAndRescue = true))//Only Search and Rescue
            )
            mainList.add(
            ...
            mainList.add(
                Employee(90,"Nils Nilsson",2,"2020-03-30",competence =  Competence(driverTruck = true,driverLadder = true))// only driver
            )
            mainList.add(
                Employee(300,"Arne Arnesson",3,"2020-05-13",competence =  Competence(searchAndRescue = true))// only search and rescue
            )
            return mainList
